...
Both notebooks auto-detect input data from `data/dev_v1/dev_v1_original/`, `data/dev_v1/dev_v1_expand/`, `data/dev_v1/dev_v1_cleaned/` (repo root), `experiments/00_baseline/`, or the notebook's working directory — set `DATA_DIR` explicitly if detection fails.
