...
| File | Regenerate |
| ---- | ---------- |
| `report/model_comparison.xlsx` (sheets: `dev_v1_original_zero_shot`, `dev_v1_original_few_shot`, `dev_v1_expand`, `dev_v1_cleaned`, `dev_v2`) | `python experiments/01_term_expansion_by_model/scripts/compare_models_to_excel.py` |
