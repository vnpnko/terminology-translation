...
This is a **thin wrapper**: no experiment-local data or results, only the `report/` tables below. It reads the shared `results/` tree.
...
Dataset-vs-dataset comparison workbooks, per baseline model, generated by [`src/analysis/compare_datasets_to_excel.py`](../../src/analysis/compare_datasets_to_excel.py) and [`src/analysis/compare_v1_variants_to_excel.py`](../../src/analysis/compare_v1_variants_to_excel.py):

| File | Regenerate |
| ---- | ---------- |
| `report/dev_v1_original_vs_dev_v2_gpt_dataset_comparison.xlsx` | `python src/analysis/compare_datasets_to_excel.py --baseline gpt` |
| `report/dev_v1_original_vs_dev_v2_qwen_3b_dataset_comparison.xlsx` | `python src/analysis/compare_datasets_to_excel.py --baseline qwen_3b` |
| `report/dev_v1_original_vs_dev_v2_qwen_7b_dataset_comparison.xlsx` | `python src/analysis/compare_datasets_to_excel.py --baseline qwen_7b` |
| `report/dev_v1_original_vs_dev_v1_dictionary_gpt_comparison.xlsx` | `python src/analysis/compare_v1_variants_to_excel.py` |
