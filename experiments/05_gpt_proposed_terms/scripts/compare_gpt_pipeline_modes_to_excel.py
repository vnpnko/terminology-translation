...
comparable. Reads:
    results/dev_v1/original/zero_shot/gpt/metrics_summary.json          (mode: proper_term)
    results/dev_v1/original/zero_shot/gpt_pipeline/metrics_summary.json (mode: gpt_proposed_term,
        produced by compute_gpt_proposed_metrics.py)
...
BEST_FILLS = {
    "proper_term": PatternFill(start_color="BDD7EE", end_color="BDD7EE", fill_type="solid"),
    "gpt_proposed_term": PatternFill(start_color="C6EFCE", end_color="C6EFCE", fill_type="solid"),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--oracle-summary",
        type=Path,
        default=Path("results/dev_v1/original/zero_shot/gpt/metrics_summary.json"),
    )
    parser.add_argument(
        "--pipeline-summary",
        type=Path,
        default=Path("results/dev_v1/original/zero_shot/gpt_pipeline/metrics_summary.json"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(
            "experiments/05_gpt_proposed_terms/report/"
            "dev_v1_original_gpt_pipeline_mode_comparison.xlsx"
        ),
    )
