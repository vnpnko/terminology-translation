...
| `results/gpt/` | GPT predictions (`{lang}_..._{mode}_predictions.jsonl`) + `metrics_summary.json` |
| `results/qwen_3b/` | Qwen predictions (`{lang}_..._{mode}_predictions.jsonl`) + `metrics_summary.json` |
