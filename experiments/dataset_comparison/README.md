...
For the dev_v1-vs-dictionary term-list-variant comparison (a different axis — original vs. externally built dictionary, not dev_v1 vs. dev_v2), see [`term_expansion/dictionary/`](../term_expansion/dictionary/README.md).
