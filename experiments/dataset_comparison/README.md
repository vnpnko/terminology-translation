...
| File | Regenerate |
| ---- | ---------- |
| `report/dev_v1_original_vs_dev_v2_dataset_comparison.xlsx` (one sheet per baseline: `gpt`, `qwen_3b`, `qwen_7b`) | `python experiments/dataset_comparison/scripts/compare_datasets_to_excel.py` |
