...
``experiments/lora_finetuning/report/base_few_shot_vs_lora_zero_shot_1_epoch.xlsx``) with a
...
Usage::
    ...
    python experiments/lora_finetuning/scripts/compare_base_vs_lora_to_excel.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("experiments/lora_finetuning/report/base_few_shot_vs_lora_zero_shot_1_epoch.xlsx"),
