...
Writes one .xlsx file (default: ``experiments/lora_finetuning/report/best_models.xlsx``)
...
Usage::
    ...
    python experiments/lora_finetuning/scripts/compare_best_models_to_excel.py
    python experiments/lora_finetuning/scripts/compare_best_models_to_excel.py --lora-run lora_3_epoch_zero_shot
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("experiments/lora_finetuning/report/best_models.xlsx"),
