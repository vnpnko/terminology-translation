...
``experiments/lora_finetuning/report/zero_shot_vs_few_shot_ablation.xlsx``) with 3 sheets:
...
Usage::
    ...
    python experiments/lora_finetuning/scripts/compare_few_shots_to_excel.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("experiments/lora_finetuning/report/zero_shot_vs_few_shot_ablation.xlsx"),
