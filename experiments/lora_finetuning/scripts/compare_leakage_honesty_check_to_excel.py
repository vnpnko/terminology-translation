...
``experiments/lora_finetuning/report/leakage_honesty_check.xlsx``) with a single sheet
...
``experiments/lora_finetuning/scripts/compare_few_shots_to_excel.py``.

Usage::

    python experiments/lora_finetuning/scripts/compare_leakage_honesty_check_to_excel.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("experiments/lora_finetuning/report/leakage_honesty_check.xlsx"),
