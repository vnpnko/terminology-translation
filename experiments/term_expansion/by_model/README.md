...
| File | Regenerate |
| ---- | ---------- |
| `report/model_comparison.xlsx` (sheets: `dev_v1_original_zero_shot`, `dev_v1_original_few_shot`, `dev_v1_expand`, `dev_v1_cleaned`, `dev_v2`) | `python experiments/term_expansion/by_model/scripts/compare_models_to_excel.py` |

`proper_term`-only comparison across dev_v1 term-list variants (`original`/`expand`/`cleaned`), rows grouped by variant then language, generated by [`scripts/compare_proper_term_across_models_to_excel.py`](scripts/compare_proper_term_across_models_to_excel.py) (sibling to `term_expansion/by_language_pair/report/dev_v1_proper_term_across_languages.xlsx`, same color scheme):

| File | Regenerate |
| ---- | ---------- |
| `report/dev_v1_proper_term_across_models.xlsx` | `python experiments/term_expansion/by_model/scripts/compare_proper_term_across_models_to_excel.py` |
