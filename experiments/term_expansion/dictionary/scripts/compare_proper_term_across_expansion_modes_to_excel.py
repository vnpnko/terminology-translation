...
``experiments/term_expansion/dictionary/report/dev_v1_proper_term_across_expansion_modes.xlsx``)
...
Usage::
    ...
    python experiments/term_expansion/dictionary/scripts/compare_proper_term_across_expansion_modes_to_excel.py
    python experiments/term_expansion/dictionary/scripts/compare_proper_term_across_expansion_modes_to_excel.py --original results/dev_v1/original/zero_shot
"""
