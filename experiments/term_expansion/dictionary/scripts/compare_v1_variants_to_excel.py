...
``experiments/term_expansion/dictionary/report/dev_v1_original_vs_dev_v1_dictionary_gpt_comparison.xlsx``).
Reads ``metrics_summary.json`` from ``<results-root>/dev_v1/original/<baseline>/``
and ``<results-root>/dev_v1/dictionary/<baseline>/``.

Usage::

    python experiments/term_expansion/dictionary/scripts/compare_v1_variants_to_excel.py
    python experiments/term_expansion/dictionary/scripts/compare_v1_variants_to_excel.py --baseline gpt
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "experiments/term_expansion/dictionary/report/"
