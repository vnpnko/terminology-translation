"""Shared helpers for build_term_dictionary.py and apply_dictionary_to_dev_v1.py."""
...
from shared.lib.data_preparation.openrouter_annotation_common import locate_substring

DEFAULT_MODEL = "openai/gpt-4o-mini"

DEV_V2_DIR = PROJECT_ROOT / "shared" / "data" / "dev_v2"
DEV_V1_ORIGINAL_DIR = PROJECT_ROOT / "shared" / "data" / "dev_v1" / "dev_v1_original"
DEV_V1_DICTIONARY_DIR = PROJECT_ROOT / "shared" / "data" / "dev_v1" / "dev_v1_dictionary"
# Only consumed by this experiment's build/apply scripts, so it lives here
# rather than under shared/data/.
TERM_DICTIONARY_DIR = (
    PROJECT_ROOT / "experiments" / "term_expansion" / "dictionary" / "data" / "dev_v2_dictionary"
)
...
def entry_matches_reference(entry: dict[str, Any], reference: str) -> bool:
