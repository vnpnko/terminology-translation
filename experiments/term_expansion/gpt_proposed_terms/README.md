...
python experiments/term_expansion/gpt_proposed_terms/scripts/compute_gpt_proposed_metrics.py
...
| `results/dev_v1/original/zero_shot/gpt_pipeline/{lang}_dev_v1_gpt_proposed_term_predictions.jsonl` | `compute_gpt_proposed_metrics.py` — per-language predictions, mirroring the layout of the other modes |
