...
Usage::
    ...
    python experiments/term_expansion/gpt_proposed_terms/scripts/compare_gpt_pipeline_modes_to_excel.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "experiments/term_expansion/gpt_proposed_terms/report/"
