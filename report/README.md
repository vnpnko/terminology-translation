...
- **Scripts:** [`experiments/term_expansion/scripts/compare_by_model_and_language.py`](../experiments/term_expansion/scripts/compare_by_model_and_language.py), [`compare_proper_term_by_model_and_language.py`](../experiments/term_expansion/scripts/compare_proper_term_by_model_and_language.py)
- **Tables:** `experiments/term_expansion/report/language_comparison.xlsx` (sheets: `dev_v1`, `dev_v2`); `experiments/term_expansion/report/proper_term_across_languages.xlsx` (`original`/`expand`/`cleaned`/`dictionary`, all 3 models)
...
- **Scripts:** [`experiments/term_expansion/scripts/compare_by_model_and_language.py`](../experiments/term_expansion/scripts/compare_by_model_and_language.py), [`compare_proper_term_by_model_and_language.py`](../experiments/term_expansion/scripts/compare_proper_term_by_model_and_language.py)
- **Tables:** `experiments/term_expansion/report/model_comparison.xlsx` (sheets: `dev_v1`, `dev_v2`); `experiments/term_expansion/report/proper_term_across_models.xlsx` (`original`/`expand`/`cleaned`/`dictionary`, all 3 models)
...
| -------------- | ----------- | --------------------------- |
| `experiments/term_expansion/report/model_comparison.xlsx` (one sheet per dataset variant) | `experiments/term_expansion/scripts/compare_by_model_and_language.py` | Model comparison table (§3.2) |
| `experiments/term_expansion/report/language_comparison.xlsx` (one sheet per dataset variant) | `experiments/term_expansion/scripts/compare_by_model_and_language.py` | Language comparison table (§3.1) |
| `experiments/term_expansion/report/proper_term_across_models.xlsx` (4 term-list variants incl. dictionary, all 3 models) | `experiments/term_expansion/scripts/compare_proper_term_by_model_and_language.py` | Term-list variant table (§3.2) |
| `experiments/term_expansion/report/proper_term_across_languages.xlsx` (4 term-list variants incl. dictionary, all 3 models) | `experiments/term_expansion/scripts/compare_proper_term_by_model_and_language.py` | Term-list variant table (§3.1) |
...
| `experiments/term_expansion/figures/fig_term_expansion_across_model.pdf` (copied to `poster/figures/`) | `experiments/term_expansion/scripts/figure_by_model.py` | Figure, §3.2 |
| `experiments/term_expansion/figures/fig_term_expansion_across_languages_{gpt,qwen_3b,qwen_7b}.pdf` (copied to `poster/figures/`) | `experiments/term_expansion/scripts/figure_by_language_pair.py` | Figure, §3.1 |
