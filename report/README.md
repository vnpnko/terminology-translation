...
- **Figures:** `poster/figures/fig_lora_epoch_ablation.pdf` (epoch ablation, both model sizes) and `poster/figures/fig_lora_best_models.pdf` (best LoRA config vs. GPT-4o-mini, by language pair).
...
| `experiments/term_expansion/by_model/figures/fig_term_expansion_across_model.pdf` (copied to `poster/figures/`) | `experiments/term_expansion/by_model/scripts/figure_by_model.py` | Figure, §3.2 |
