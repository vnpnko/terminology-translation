...
- **Repo location:** [`experiments/term_expansion/by_language_pair/`](../experiments/term_expansion/by_language_pair/README.md) (modes) and [`experiments/term_expansion/dataset_comparison/`](../experiments/term_expansion/dataset_comparison/README.md) (dictionary variant)
- **Scripts:** [`experiments/term_expansion/by_language_pair/scripts/compare_languages_to_excel.py`](../experiments/term_expansion/by_language_pair/scripts/compare_languages_to_excel.py), [`experiments/term_expansion/dataset_comparison/scripts/compare_v1_variants_to_excel.py`](../experiments/term_expansion/dataset_comparison/scripts/compare_v1_variants_to_excel.py)
- **Tables:** `experiments/term_expansion/by_language_pair/report/language_comparison.xlsx` (sheets: `dev_v1_original_zero_shot`, `dev_v1_original_few_shot`, `dev_v1_expand`, `dev_v1_cleaned`, `dev_v2`); `experiments/term_expansion/dataset_comparison/report/dev_v1_original_vs_dev_v1_dictionary_gpt_comparison.xlsx`
...
- **Script:** [`experiments/term_expansion/by_model/scripts/compare_models_to_excel.py`](../experiments/term_expansion/by_model/scripts/compare_models_to_excel.py)
- **Tables:** `experiments/term_expansion/by_model/report/model_comparison.xlsx` (sheets: `dev_v1_original_zero_shot`, `dev_v1_original_few_shot`, `dev_v1_expand`, `dev_v1_cleaned`, `dev_v2`)
...
- **Repo location:** [`experiments/term_expansion/dataset_comparison/`](../experiments/term_expansion/dataset_comparison/README.md)
- **Script:** [`experiments/term_expansion/dataset_comparison/scripts/compare_datasets_to_excel.py`](../experiments/term_expansion/dataset_comparison/scripts/compare_datasets_to_excel.py)
...
- **Canonical runs** (from [`scripts/run_registry.json`](../experiments/lora_finetuning/scripts/run_registry.json)): `base_few_shot` (no fine-tuning, few-shot), `lora_1_epoch_few_shot`, `lora_1_epoch_zero_shot`, `lora_2_epoch_zero_shot`, `lora_3_epoch_zero_shot`, for both 3B and 7B, plus `gpt_base`. Run ids use the `zero_shot`/`few_shot` vocabulary (see experiment README § Naming standard) — the underlying result folders use different names (see that README's run table for the mapping).
- **Tables:** five comparison workbooks in `experiments/lora_finetuning/report/` (see [experiment README § Report tables](../experiments/lora_finetuning/README.md#report-tables)): `leakage_honesty_check.xlsx`, `base_few_shot_vs_lora_zero_shot_1_epoch.xlsx`, `best_models.xlsx`, `epoch_ablation.xlsx`, `zero_shot_vs_few_shot_ablation.xlsx`, all fully script-generated. `best_models.xlsx` cites the **2-epoch** LoRA run as "best" — see the experiment README's note on the overfitting evidence behind that choice.
...
| `experiments/term_expansion/dataset_comparison/report/dev_v1_original_vs_dev_v2_dataset_comparison.xlsx` (one sheet per model) | `experiments/term_expansion/dataset_comparison/scripts/compare_datasets_to_excel.py` | dev_v1 vs dev_v2 table (§3.3) |
| `experiments/term_expansion/dataset_comparison/report/dev_v1_original_vs_dev_v1_dictionary_gpt_comparison.xlsx` | `experiments/term_expansion/dataset_comparison/scripts/compare_v1_variants_to_excel.py` | Dictionary vs original table (§3.1) |
| `experiments/lora_finetuning/report/base_few_shot_vs_lora_zero_shot_1_epoch.xlsx` | `experiments/lora_finetuning/scripts/compare_base_vs_lora_to_excel.py` | Base-few-shot vs LoRA-1-epoch table (§3.4) |
| `experiments/lora_finetuning/report/best_models.xlsx` | `experiments/lora_finetuning/scripts/compare_best_models_to_excel.py` | Best LoRA vs GPT table (§3.4) |
| `experiments/lora_finetuning/report/epoch_ablation.xlsx` | `experiments/lora_finetuning/scripts/compare_epochs_to_excel.py` | Epoch ablation table (§3.4) |
| `experiments/lora_finetuning/report/zero_shot_vs_few_shot_ablation.xlsx` | `experiments/lora_finetuning/scripts/compare_few_shots_to_excel.py` | Few-shot ablation table (§3.4.1) |
| `experiments/lora_finetuning/report/leakage_honesty_check.xlsx` | `experiments/lora_finetuning/scripts/compare_leakage_honesty_check_to_excel.py` | Leakage honesty-check table (§3.4.2) |
...
| `experiments/term_expansion/dataset_comparison/figures/fig_dev_v1_vs_dev_v2_training.pdf` (copied to `report/figures/`) | `experiments/term_expansion/dataset_comparison/scripts/figure_dataset_comparison.py` | Figure, §3.3 |
