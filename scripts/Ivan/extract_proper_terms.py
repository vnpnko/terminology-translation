...
DEFAULT_INPUTS = sorted(
    (ROOT / name)
    for name in ("orig/ende_dev.jsonl", "orig/enes_dev.jsonl", "orig/enru_dev.jsonl")
)
DEFAULT_OUTPUT = ROOT / "proper terms" / "all_eng_proper_terms.txt"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=f"Output text file (default: {DEFAULT_OUTPUT.relative_to(ROOT)})",
    )
