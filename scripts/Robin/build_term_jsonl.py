...
Usage::
    ...
    python build_term_jsonl.py -t de --data-dir "../../data/asap data v2/orig data/ende"
    python build_term_jsonl.py -t ru --data-dir "../../data/asap data v2/orig data/enru"
...
DEFAULT_DATA_ROOT = REPO_ROOT / "data" / "asap data v2" / "orig data"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(default: data/asap data v2/orig data/<ende|enes|enru>)"
        ),
    )
    parser.add_argument(
        "--out-jsonl",
