...
each with 3 language rows (ende, enru, enes). The model column is merged per block.
    ...
    python scripts/analysis/compare_modes_to_excel.py results/dev_v1/original
    python scripts/analysis/compare_modes_to_excel.py results/dev_v1/expand
    python scripts/analysis/compare_modes_to_excel.py results/dev_v1/cleaned
    python scripts/analysis/compare_modes_to_excel.py results/dev_v2
"""
