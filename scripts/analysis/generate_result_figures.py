...
Usage:
    python scripts/analysis/generate_result_figures.py
    python scripts/analysis/generate_result_figures.py --only exp1 exp5
    python scripts/analysis/generate_result_figures.py --output-dir report/figures
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output directory for figures (default: <project-root>/report/figures)",
    )
    parser.add_argument(
        "--only",
        nargs="+",
    ...
    output_dir = (
        ...
        if args.output_dir
        else project_root / "report" / "figures"
    )
