...
Reads dictionary from data/term_dictionary/ and enriches proper_terms in dev_v1
using reference-based disambiguation. Writes new files to data/dev_v1/dictionary/
only — never overwrites original/, expand/, or cleaned/.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--force",
        action="store_true",
        help="Overwrite existing output in data/dev_v1/dictionary/",
    )
