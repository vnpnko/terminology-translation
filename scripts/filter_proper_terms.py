...
DEFAULT_INPUT = ROOT / "proper terms" / "all_eng_proper_terms.txt"
DEFAULT_OUTPUT = ROOT / "proper terms" / "filtered_eng_proper_terms.txt"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=f"Input term list (default: {DEFAULT_INPUT.relative_to(ROOT)})",
    )
    parser.add_argument(
        "-o",
        "--output",
        ...
        help=f"Output term list (default: {DEFAULT_OUTPUT.relative_to(ROOT)})",
    )
    parser.add_argument(
        "--blocklist",
        type=Path,
