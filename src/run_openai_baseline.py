#!/usr/bin/env python3
"""
Run GPT-4o-mini baseline via OpenRouter (same logic as experiments/04_baseline/notebooks/openai_baseline.ipynb).

Usage::

    python src/run_openai_baseline.py \\
        --data-dir data/interim/dev_v1_dictionary \\
        --data-variant dictionary \\
        --output-dir results/dev_v1/dictionary/gpt

    python src/run_openai_baseline.py \\
        --data-dir data/raw/dev_v1_original \\
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--data-dir",
        type=Path,
        default=REPO_ROOT / "data" / "interim" / "dev_v1_dictionary",
    )
